...
class PCAVisual():
    ...
    def plot_pca(self,figsize=(8,8),dpi=60,savefig=False,output_path=None):
        ...
        plt.xlabel(f'PC1 ({EV_PC1})',fontsize=40)
        plt.ylabel(f'PC2 ({EV_PC2})',fontsize=40)
    ...
    def plot_pca_with_proba(self,figsize=(8,8),dpi=60,savefig=False,output_path=None):
        """
